...
## [Introdução à infraestrutura de nuvem: Descrever a arquitetura e os serviços do Azure](https://learn.microsoft.com/pt-br/training/paths/azure-fundamentals-describe-azure-architecture-services/)
...
## [Introdução à infraestrutura de nuvem: Descrever o gerenciamento e a governança do Azure](https://learn.microsoft.com/pt-br/training/paths/describe-azure-management-governance/)

### Módulos neste roteiro de aprendizagem

* [Descrever o gerenciamento de custos no Azure](https://learn.microsoft.com/pt-br/training/modules/describe-cost-management-azure/)
  * Este módulo explora métodos para estimar, acompanhar e gerenciar custos no Azure.

* [Descrever os recursos e as ferramentas de governança e conformidade no Azure](https://learn.microsoft.com/pt-br/training/modules/describe-features-tools-azure-for-governance-compliance/)
  * Este módulo apresenta ferramentas que podem ajudar com a governança e a conformidade no Azure.

* [Descrever recursos e ferramentas para gerenciar e implantar recursos do Azure](https://learn.microsoft.com/pt-br/training/modules/describe-features-tools-manage-deploy-azure-resources/)
  * Este módulo aborda ferramentas que ajudam você a gerenciar seus recursos locais e do Azure.

* [Descrever as ferramentas de monitoramento no Azure](https://learn.microsoft.com/pt-br/training/modules/describe-monitoring-tools-azure/)
